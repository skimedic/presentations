...
// ==================================
// EntityFrameworkCore - EfCoreBasics - VSalesPerson.cs
...
public partial class VSalesPerson
{
    ...
    [StringLength(50)] public string TerritoryName { get; set; }

    [StringLength(50)] public string TerritoryGroup { get; set; }
