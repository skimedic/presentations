...
// ==================================
// Channel9 - EfCore - B_SimpleQueries.cs
...
namespace EfCore
{
    public class SimpleQueries
    {
        ...
        public void SelectWithMultipleClauses()
        {
            ...
            //Chained statements
            var query2 = _context.Person.Where(x => x.PersonType == "em");
                query2 = query2.Where(x => x.EmailPromotion == 1);
        ...
        public void ProblemQueries()
        {
            try
            {
                //This can't be translated into SQL by the SQL Server translation engine
