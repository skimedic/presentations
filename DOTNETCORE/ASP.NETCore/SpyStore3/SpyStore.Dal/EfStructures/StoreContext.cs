...
namespace SpyStore.Dal.EfStructures
{
    public class StoreContext : DbContext
    {
        ...
        {
            modelBuilder.Entity<CartRecordWithProductInfo>().HasNoKey().ToTable("CartRecordWithProductInfo", "Store");
            modelBuilder.Entity<OrderDetailWithProductInfo>().HasNoKey().ToTable("OrderDetailWithProductInfo", "Store");
