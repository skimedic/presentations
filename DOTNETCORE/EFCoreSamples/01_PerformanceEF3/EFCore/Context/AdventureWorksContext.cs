...
namespace PerformanceEf3.EFCore.Context
{
    ...
    {
        public virtual DbSet<CustomerQuery> CustomersQuery { get; set; }
        public virtual DbSet<CustomerView> CustomersView { get; set; }

        public virtual DbSet<ModelForTestingQueryType> ModelForTestingQueryType { get; set; }
        ...
        {
            modelBuilder.Entity<CustomerQuery>().HasNoKey().ToTable("Customer", "Sales");
            modelBuilder.Entity<CustomerView>().HasNoKey().ToTable("CustomerView","dbo");
            modelBuilder.Entity<ModelForTestingQueryType>().HasNoKey();
