...
namespace WPF.Helpers
{
    ...
    public class WatermarkTextBehavior : Behavior<TextBox>
    {
        ...
        /// <param name="tb"></param>
        /// <returns></returns>
        public static bool GetIsWatermarked(TextBox tb) => (bool)tb.GetValue(IsWatermarkedProperty);
        ...
        {
	        if (string.Compare(AssociatedObject.Text, this.Text, StringComparison.OrdinalIgnoreCase) != 0) return;
